  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-semibold text-zinc-900">Maker</h1>
      ...
      {!sessions || sessions.length === 0 ? (
        <div className="rounded-xl border border-dashed border-zinc-300 p-16 text-center">
          ...
          <p className="text-zinc-400 text-xs mt-1 mb-6">
            Create one by pasting a job description.
          </p>
          <Link
            href="/maker/new"
            className="rounded-lg bg-zinc-900 px-4 py-2 text-sm font-medium text-white hover:bg-zinc-700 transition-colors"
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-zinc-900 truncate">
                  {s.title || <span className="text-zinc-400 font-normal">Untitled</span>}
                </p>
